<template>
  <q-page padding>
    ...
    <div class="q-pa-md">
      <q-btn color="grey-8" icon="add" label="New Event Status"/>
    </div>
    <div class="q-pa-md">
      <q-table
    ...
    >
        <q-tr slot="body" slot-scope="props" :props="props">
          ...
          <q-td><q-btn color="grey-8" label="View" v-bind:to="'/cms/settings/event_status#'+props.row.id" size="sm" icon="search"/></q-td>
        </q-tr>
      </q-table>
    </div>
  </q-page>
